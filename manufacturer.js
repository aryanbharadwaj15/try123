...
submitBtn.addEventListener('click', () => {
    ...
    if (!manufacturer || !medicineName || !medicineId || !batchNumber || !quantity || !manufactureDate || !expiryDate) {
...
generateQrBtn.addEventListener('click', () => {
    ...
    const qrLink = `https://try123met.netlify.app/medicine-details.html?key=${lastSavedMedicineKey}`;
    qrCodeDiv.innerHTML = '';
